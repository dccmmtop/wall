export default class Api {
  ...
  static getNotices = Api.base_url + "/notifications/get_all_notices";
  static getNotice = Api.base_url + "/notifications/get_notice";
  static hasNotRead = Api.base_url + "/notifications/has_not_read";
  static clearNotices = Api.base_url + "/notifications/clear_notices";
}
